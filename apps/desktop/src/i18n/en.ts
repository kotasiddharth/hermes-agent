...
export const en: Translations = {
  ...
  settings: {
    ...
    appearance: {
      ...
      glassDesc: 'Adds a frosted finish to app chrome, menus, and panels. The live chat stays unblurred for responsiveness.',
      glassSolid: 'Solid',
      glassSubtle: 'Subtle',
      glassFrosted: 'Frosted',
      translucencyTitle: 'Window Translucency',
      translucencyDesc: 'Lets your desktop show through the whole app. Separate from the in-app glass effect. macOS and Windows only.',
  ...
  composer: {
    ...
    contextWindowFull: percent => `${percent}% full`,
