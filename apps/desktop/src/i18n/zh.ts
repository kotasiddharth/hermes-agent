...
export const zh: Translations = {
  ...
  settings: {
    ...
    general: {
      ...
      hapticsTitle: '触感反馈',
      hapticsDesc: '设备支持时，为应用操作提供轻微的触感反馈。',
      swapSidebarSidesDesc: '将会话侧栏放到右侧，将工作区面板放到左侧。',
    ...
    plugins: {
      ...
      integrationsDescription: '安装一次工具。每次打开应用时，Hermes 都会自动启动它。',
      integrationsCount: n => `${n} 个就绪`,
      integrationsLoading: '正在加载集成...',
      integrationsLoadFailed: '无法加载集成。',
      integrationsRetry: '重试',
      integrationsEmpty: '目前没有可用的集成。',
      integrationsInstall: '安装',
      integrationsInstalling: '正在设置...',
      integrationsInstallFailed: name => `无法设置 ${name}`,
      integrationsReady: '就绪',
      integrationsDisabled: '未激活',
      integrationsActivate: '激活',
      integrationsNeedsSignIn: '需要登录',
      integrationsSignIn: '登录',
      integrationsOAuth: '登录',
      integrationsApiKey: 'API 密钥',
      integrationsNeedsBuild: '需要构建',
      integrationsCredentialsTitle: name => `设置 ${name}`,
      integrationsCredentialsDescription: '保存在此配置文件中，并会在 Hermes 启动时自动复用。',
      integrationsCredentialsRequired: '请填写必填项后再继续。',
      integrationsBrowserUnavailable: '无法打开浏览器进行登录。',
      integrationReady: name => `${name} 已就绪`,
      integrationReadyMessage: '它会立即在当前对话中启动，并在每次打开 Hermes 时自动启动。',
      integrationReadyNextLaunch: '下次打开 Hermes 时会自动启动。'
    },
    notifications: {
      title: '通知',
    ...
    appearance: {
      ...
      glassTitle: '毛玻璃效果',
      glassDesc: '为应用栏、菜单和面板添加半透明磨砂效果。实时聊天内容不会模糊，以保持响应迅速。',
      glassSolid: '实色',
      glassSubtle: '轻微',
      glassFrosted: '磨砂',
  ...
  skills: {
    ...
    hub: {
      title: '浏览中心',
      description: '为你的工作安装技能和集成。',
      searchPlaceholder: '搜索技能和集成…',
      search: '搜索',
      searching: '搜索中…',
      ...
      marketplaces: '你的市场',
      addMarketplace: '添加市场',
      addingMarketplace: '正在添加…',
      removeMarketplace: '移除',
      removingMarketplace: '正在移除…',
      githubRepository: 'GitHub 仓库',
      githubRepositoryPlaceholder: 'https://github.com/owner/repository',
      marketplaceDescription: '添加一个在 skills 文件夹中包含技能的公开 GitHub 仓库。',
      marketplaceInvalid: '请输入 GitHub 仓库 URL 或 owner/repository。',
      marketplaceAdded: repo => `已添加 ${repo}`,
      marketplaceAlreadyAdded: repo => `${repo} 已添加`,
      marketplaceRemoved: repo => `已移除 ${repo}`,
      marketplaceFailed: '无法添加市场',
      marketplaceRemoveFailed: '无法移除市场',
      filterAll: '全部',
      filterSkills: '技能',
      filterIntegrations: '集成',
      skill: '技能',
      results: '结果',
      integrationsTitle: '集成',
      integrationsDescription: '经过筛选的工具，完成一次设置后会自动启动。',
      featured: '精选技能',
      landingHint: '浏览精选技能和集成，只安装有助于你工作的内容。',
      noResults: '没有匹配的技能或集成。',
  ...
  composer: {
    ...
    contextWindow: '上下文窗口',
    contextWindowUsageSummary: (usedPercent, remainingPercent) => `已使用 ${usedPercent}%（剩余 ${remainingPercent}%）`,
    contextWindowUnavailable: '上下文窗口数据暂不可用。',
    contextWindowUsage: (used, total) => `已使用 ${used} / ${total} 个词元`,
    lookupLoading: '查找中…',
  ...
  assistant: {
    thread: {
      ...
      browseConversationHistory: '浏览对话历史',
      showEarlier: '显示更早的消息',
