...
export const en: Translations = {
  ...
  settings: {
    ...
    plugins: {
      ...
      integrationsDescription: 'Install a tool once. Hermes starts it automatically whenever you open the app.',
      integrationsCount: n => `${n} ready`,
      integrationsLoading: 'Loading integrations...',
      integrationsLoadFailed: 'Could not load integrations.',
      integrationsRetry: 'Try again',
      integrationsEmpty: 'No integrations are available right now.',
      integrationsInstall: 'Install',
      integrationsInstalling: 'Setting up...',
      integrationsInstallFailed: name => `Could not set up ${name}`,
      integrationsReady: 'Ready',
      integrationsDisabled: 'Inactive',
      integrationsActivate: 'Activate',
      integrationsNeedsSignIn: 'Sign-in required',
      integrationsSignIn: 'Sign in',
      integrationsOAuth: 'Sign-in',
      integrationsApiKey: 'API key',
      integrationsNeedsBuild: 'Needs build',
      integrationsCredentialsTitle: name => `Set up ${name}`,
    ...
    appearance: {
      ...
      glassTitle: 'Glass Surfaces',
      glassDesc:
        'Adds a frosted finish to app chrome, menus, and panels. The live chat stays unblurred for responsiveness.',
      glassSolid: 'Solid',
      glassSubtle: 'Subtle',
      glassFrosted: 'Frosted',
      translucencyTitle: 'Window Translucency',
      translucencyDesc:
        'Lets your desktop show through the whole app. Separate from the in-app glass effect. macOS and Windows only.',
      translucencySolid: 'Solid',
      translucencySoft: 'Light',
      translucencyClear: 'Clear',
    ...
    providers: {
      ...
      noAccounts: 'No sign-in accounts are available.',
  ...
  skills: {
    ...
    hub: {
      title: 'Browse Hub',
      description: 'Install skills and integrations for the work you do.',
      searchPlaceholder: 'Search skills and integrations...',
      search: 'Search',
      searching: 'Searching...',
      connectingHubs: 'Connecting to skill hubs...',
      connectedHubs: 'Connected hubs:',
      sources: 'Sources',
      marketplaces: 'Your marketplaces',
      ...
      marketplaceDescription: 'Add a public GitHub repository with skills in its skills folder.',
      marketplaceInvalid: 'Enter a GitHub repository URL or owner/repository.',
      marketplaceAdded: repo => `Added ${repo}`,
      marketplaceAlreadyAdded: repo => `${repo} is already added`,
      marketplaceRemoved: repo => `Removed ${repo}`,
      marketplaceFailed: 'Could not add marketplace',
      marketplaceRemoveFailed: 'Could not remove marketplace',
      filterAll: 'All',
      filterSkills: 'Skills',
      ...
      results: 'Results',
      integrationsTitle: 'Integrations',
      integrationsDescription: 'Curated tools that start automatically after a one-time setup.',
      featured: 'Featured skills',
      landingHint: 'Browse curated skills and integrations, then install only what helps with your work.',
      noResults: 'No matching skills or integrations found.',
  ...
  composer: {
    ...
    contextWindowUsageSummary: (usedPercent, remainingPercent) => `${usedPercent}% used (${remainingPercent}% left)`,
    contextWindowUnavailable: 'Context window data is not available yet.',
    contextWindowUsage: (used, total) => `${used} / ${total} tokens used`,
    ...
    queueSend: 'Send',
    queueDelete: 'Delete',
    queueMoreActions: 'More queue actions',
    queueResume: 'Resume',
  ...
  assistant: {
    thread: {
      ...
      browseConversationHistory: 'Browse conversation history',
