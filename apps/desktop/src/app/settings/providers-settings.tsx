...
function ConnectedProviderRow({
  ...
  return (
    <div className="group grid grid-cols-[minmax(0,1fr)_auto] items-center gap-1 rounded-[var(--radius-sm)] transition-colors duration-200 hover:bg-(--ui-control-hover-background)">
