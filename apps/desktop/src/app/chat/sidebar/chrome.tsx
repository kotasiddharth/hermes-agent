...
// Keep a real line box for font ascenders/descenders. `leading-none` let the
// glyphs extend beyond the 28px row when the scroll viewport ended on a row,
// which made the bottom of recent titles look clipped in short sidebars.
const rowLabel = 'min-w-0 truncate text-[0.8125rem] leading-4 text-(--ui-text-secondary)'
