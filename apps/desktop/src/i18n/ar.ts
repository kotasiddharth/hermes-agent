...
export const ar = defineLocale({
  ...
  settings: {
    ...
    general: {
      ...
      hapticsTitle: 'التغذية اللمسية',
      hapticsDesc: 'استخدم استجابة لمسية خفيفة لإجراءات التطبيق عند دعم جهازك لها.',
    ...
    appearance: {
      ...
      glassTitle: 'أسطح زجاجية',
      glassDesc:
        'يضيف لمسة زجاجية ضبابية إلى أشرطة التطبيق والقوائم واللوحات. تبقى المحادثة المباشرة بلا ضباب للحفاظ على الاستجابة.',
      glassSolid: 'مصمت',
      glassSubtle: 'خفيف',
      glassFrosted: 'ضبابي',
      translucencyTitle: 'شفافية النافذة',
      translucencyDesc: 'إظهار سطح المكتب من خلال النافذة بالكامل. متاح على macOS وWindows فقط.',
      translucencySolid: 'مصمت',
      translucencySoft: 'خفيف',
      translucencyClear: 'واضح',
    ...
    providers: {
      ...
      noAccounts: 'لا توجد حسابات تسجيل دخول متاحة.',
  ...
  skills: {
    ...
    hub: {
      ...
      addingMarketplace: 'جارٍ الإضافة…',
      removeMarketplace: 'إزالة',
      removingMarketplace: 'جارٍ الإزالة…',
      githubRepository: 'مستودع GitHub',
      githubRepositoryPlaceholder: 'https://github.com/owner/repository',
      marketplaceDescription: 'أضف مستودع GitHub عامًا يحتوي على مهارات في مجلد skills.',
      marketplaceInvalid: 'أدخل رابط مستودع GitHub أو owner/repository.',
      marketplaceAdded: repo => `تمت إضافة ${repo}`,
      marketplaceAlreadyAdded: repo => `${repo} مضاف بالفعل`,
      marketplaceRemoved: repo => `تمت إزالة ${repo}`,
      marketplaceFailed: 'تعذرت إضافة السوق',
      marketplaceRemoveFailed: 'تعذرت إزالة السوق'
    }
  },
  agents: {
    close: 'إغلاق الوكلاء',
  ...
  composer: {
    ...
    queueMoreActions: 'مزيد من إجراءات قائمة الانتظار',
